    ...
    <>
      ...
      {open ? (
        <>
          ...
          <aside
            aria-modal={true}
            className="fixed inset-y-0 right-0 z-[60] flex w-[min(88vw,24rem)] flex-col bg-surface-container-lowest shadow-2xl transition-transform duration-200 md:hidden translate-x-0"
