# Hoeren 2 Textstellen zu Begriffspaar notieren

## Purpose
Generate and evaluate listening tasks that capture key claims and support in linked note pairs.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Hoeren 2 Textstellen zu Begriffspaar notieren in the Hoeren section.
...
## Skill Tags
listening.detail_comprehension, task.source_mediation, task.argumentation
