# Hoeren 3 Fehler in Zusammenfassung erkennen

## Purpose
Generate and evaluate tasks that compare an audio source with a written summary and detect inaccuracies.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Hoeren 3 Fehler in Zusammenfassung erkennen in the Hoeren section.
...
## Skill Tags
listening.detail_comprehension, task.source_mediation, reading.detail_comprehension
