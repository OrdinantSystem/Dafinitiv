# Hoeren 4 Aussagen Personen zuordnen

## Purpose
Generate and evaluate panel-discussion tasks where statements must be assigned to the correct speaker.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Hoeren 4 Aussagen Personen zuordnen in the Hoeren section.
...
## Skill Tags
listening.global_comprehension, listening.detail_comprehension, task.argumentation
