# Hoeren 5 Gliederungspunkte zu Vortrag ergaenzen

## Purpose
Generate and evaluate outline-completion tasks based on a short lecture or talk.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Hoeren 5 Gliederungspunkte zu Vortrag ergaenzen in the Hoeren section.
...
## Skill Tags
listening.detail_comprehension, task.source_mediation, lexicon.academic_vocabulary
