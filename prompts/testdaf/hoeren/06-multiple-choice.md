# Hoeren 6 Multiple Choice

## Purpose
Generate and evaluate multiple-choice listening tasks with academic or informational audio input.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Hoeren 6 Multiple Choice in the Hoeren section.
...
## Skill Tags
listening.global_comprehension, listening.detail_comprehension
