# Lesen 1 Lueckentext ergaenzen

## Purpose
Generate and evaluate gap-fill reading tasks that require context-sensitive lexical choice in a short academic-style passage.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Lesen 1 Lueckentext ergaenzen in the Lesen section.
...
## Skill Tags
reading.detail_comprehension, lexicon.academic_vocabulary, lexicon.collocations, grammar.case_and_articles
