# Lesen 2 Textabschnitte ordnen

## Purpose
Generate and evaluate paragraph-order tasks that test text logic, cohesion, and discourse sequencing.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Lesen 2 Textabschnitte ordnen in the Lesen section.
...
## Skill Tags
reading.global_comprehension, discourse.cohesion, grammar.connectors_and_subordination
