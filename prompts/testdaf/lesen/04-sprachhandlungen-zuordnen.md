# Lesen 4 Sprachhandlungen zuordnen

## Purpose
Generate and evaluate tasks that identify rhetorical purpose, communicative action, and stance.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Lesen 4 Sprachhandlungen zuordnen in the Lesen section.
...
## Skill Tags
reading.detail_comprehension, task.argumentation, discourse.register
