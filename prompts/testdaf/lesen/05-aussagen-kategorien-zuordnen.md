# Lesen 5 Aussagen Kategorien zuordnen

## Purpose
Generate and evaluate statement-to-category matching tasks based on distributed evidence in a text.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Lesen 5 Aussagen Kategorien zuordnen in the Lesen section.
...
## Skill Tags
reading.global_comprehension, reading.detail_comprehension, task.task_fulfillment
