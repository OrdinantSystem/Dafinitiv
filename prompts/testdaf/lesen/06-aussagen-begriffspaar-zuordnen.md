# Lesen 6 Aussagen einem Begriffspaar zuordnen

## Purpose
Generate and evaluate conceptual matching tasks where statements must be assigned to the right category pair.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Lesen 6 Aussagen einem Begriffspaar zuordnen in the Lesen section.
...
## Skill Tags
reading.detail_comprehension, task.argumentation, lexicon.academic_vocabulary
