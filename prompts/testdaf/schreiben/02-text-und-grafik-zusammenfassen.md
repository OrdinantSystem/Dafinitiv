# Schreiben 2 Informationen aus Text und Grafik zusammenfassen

## Purpose
Generate and evaluate integrated writing tasks that summarize information from a text and a graphic.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Schreiben 2 Informationen aus Text und Grafik zusammenfassen in the Schreiben section.
...
## Skill Tags
writing.written_production, task.source_mediation, task.task_fulfillment, reading.detail_comprehension, discourse.cohesion
