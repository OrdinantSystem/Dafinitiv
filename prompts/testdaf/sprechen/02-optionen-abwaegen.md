# Sprechen 2 Optionen abwaegen

## Purpose
Generate and evaluate spoken tasks that compare options and justify a recommendation.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Sprechen 2 Optionen abwaegen in the Sprechen section.
...
## Skill Tags
speaking.spoken_production, task.argumentation, discourse.cohesion, discourse.register
