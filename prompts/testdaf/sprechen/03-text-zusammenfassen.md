# Sprechen 3 Text zusammenfassen

## Purpose
Generate and evaluate integrated spoken summary tasks based on a written source.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Sprechen 3 Text zusammenfassen in the Sprechen section.
...
## Skill Tags
reading.global_comprehension, task.source_mediation, speaking.spoken_production, task.task_fulfillment
