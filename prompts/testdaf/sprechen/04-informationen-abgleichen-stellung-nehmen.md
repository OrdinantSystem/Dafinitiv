# Sprechen 4 Informationen abgleichen Stellung nehmen

## Purpose
Generate and evaluate integrated spoken tasks that compare spoken information with a graphic and require a position.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Sprechen 4 Informationen abgleichen Stellung nehmen in the Sprechen section.
...
## Skill Tags
listening.detail_comprehension, task.source_mediation, task.argumentation, speaking.spoken_production
