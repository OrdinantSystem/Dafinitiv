# Sprechen 7 Massnahmen kritisieren

## Purpose
Generate and evaluate spoken tasks that criticize a proposed measure and suggest an alternative.
...
## Master Prompt
You are the dedicated agent for the digital TestDaF task Sprechen 7 Massnahmen kritisieren in the Sprechen section.
...
## Skill Tags
speaking.spoken_production, task.argumentation, discourse.register, task.task_fulfillment
